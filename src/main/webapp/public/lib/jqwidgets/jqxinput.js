			...
			.extend(
					a.jqx._jqxInput.prototype,
					{
						...
						render : function() {
							if (this.element.nodeName.toLowerCase() == "textarea") {
								...
								if (this.element.nodeName.toLowerCase() == "div") {
									...
									if (!d) {
										throw new Error(
												"jqxInput: Missing Text Input in the Input Group")
									}
									if (b.length > 0) {
										this.baseHost = a(this.element);
										this.host = b;
										this.element = b[0];
										this.baseHost.addClass(this
												.toThemeProperty("jqx-widget"));
										this.baseHost.addClass(this
												.toThemeProperty("jqx-rc-all"));
										this.baseHost
												.addClass(this
														.toThemeProperty("jqx-input-group"));
						...
						_updateSource : function() {
								...
								e = a
										.map(
												...
												function(h) {
													...
													if (typeof h != "string"
															&& h instanceof String == false) {
														var g = "";
														var i = "";
														if (d.displayMember != ""
																&& d.displayMember != undefined) {
															if (h[d.displayMember]) {
																g = h[d.displayMember]
															}
														}
														if (d.valueMember != ""
																&& d.valueMember != undefined) {
															i = h[d.valueMember]
														}
														if (g == "") {
															g = h.label
							...
							if (this.source && this.source._source) {
								...
								if (this.adapter._source.localdata != null) {
									...
									this.adapter.bindBindingUpdate(
						...
						_refreshClasses : function(c) {
							...
							this.$popup[b](this
									.toThemeProperty("jqx-input-popup"));
							...
							if (this.roundedCorners) {
								this.host[b]
										(this.toThemeProperty("jqx-rc-all"));
								this.$popup[b](this
										.toThemeProperty("jqx-rc-all"))
							}
							if (this.disabled) {
							...
							if (!this.baseHost) {
								...
								if (this.height) {
									...
									if (a.jqx.browser.msie
										...
										this.baseHost.css("display",
												"inline-block")
									}
									a
											.each(
													this.baseHost.children(),
													function() {
														a(this).css("height",
																"100%");
														if (a.jqx.browser.msie
									...
									this.host.css("width", this.baseHost
											.width()
											- c - 4 + "px");
									if (a.jqx.browser.msie
						...
						select : function(c, d) {
							var e = this.$popup.find(".jqx-fill-state-pressed")
									.attr("data-value");
							var b = this.$popup.find(".jqx-fill-state-pressed")
									.attr("data-name");
							this.element.value = this.renderer(b,
									this.element.value);
							this.selectedItem = {
								label : b,
								value : e
							};
							this.host.attr("data-value", e);
						...
						suggest : function(c) {
							...
							if (a.isFunction(this.source)) {
								b = this.source(this.query, a.proxy(this.load,
										this))
							} else {
								b = this.source
							}
						...
						_sort : function(b) {
							...
							for (var c = 0; c < b.length; c++) {
								...
								if (g.toString().toLowerCase().indexOf(
										this.query.toString().toLowerCase()) === 0) {
									h.push(e)
								} else {
						...
						next : function(c) {
							var d = this.$popup
									.find(".jqx-fill-state-pressed")
									.removeClass(
											this
													.toThemeProperty("jqx-fill-state-pressed")), b = d
									.next();
							if (!b.length) {
						...
						addHandlers : function() {
							this.addHandler(this.host, "focus", a.proxy(
									this.onFocus, this));
							this.addHandler(this.host, "blur", a.proxy(
									this.onBlur, this));
							this.addHandler(this.host, "keypress", a.proxy(
									this.keypress, this));
							this.addHandler(this.host, "keyup", a.proxy(
									this.keyup, this));
							this.addHandler(this.host, "keydown", a.proxy(
									this.keydown, this));
							this.addHandler(this.$popup, "mousedown", a.proxy(
									this.click, this));
							if (this.host.on) {
								this.$popup.on("mouseenter", "li", a.proxy(
										this.mouseenter, this))
							} else {
								this.$popup.bind("mouseenter", "li", a.proxy(
										this.mouseenter, this))
							}
						},
						removeHandlers : function() {
							this.removeHandler(this.host, "focus", a.proxy(
									this.onFocus, this));
							this.removeHandler(this.host, "blur", a.proxy(
									this.onBlur, this));
							this.removeHandler(this.host, "keypress", a.proxy(
									this.keypress, this));
							this.removeHandler(this.host, "keyup", a.proxy(
									this.keyup, this));
							this.removeHandler(this.host, "keydown", a.proxy(
									this.keydown, this));
							this.removeHandler(this.$popup, "mousedown", a
									.proxy(this.click, this));
							if (this.host.off) {
								this.$popup.off("mouseenter", "li", a.proxy(
										this.mouseenter, this))
							} else {
								this.$popup.unbind("mouseenter", "li", a.proxy(
										this.mouseenter, this))
							}
						},
						move : function(b) {
